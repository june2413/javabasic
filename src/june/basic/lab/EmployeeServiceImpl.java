...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    // 멤버변수 선언
    List<EmployeeV0> empdata = new ArrayList<>();
    EmployeeV0 emp = null;
    ...
    @Override
    public void makeExtInfo(EmployeeV0 emp) {
