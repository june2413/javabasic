...
public class Generics {
    public static void main(String[] args) {
        ...
        // Object형으로 배열을 선언하면 어떤 데이터타입의 객체든 모두 저장가능
        Object[] zoo1 = new Object[3];
        zoo1[0] = lion1;
        zoo1[1] = tiger1;
        zoo1[2] = zebra1;

        // 단, 배열에서 객체를 빼낼때는 그 데아터타입에 맞는
        // 적절한 형변환이 필요함
        ((Lion)zoo1[0]).sayName();
...
//                        Integer.parseInt(numbers2[2]));
       ...
       // ArrayList<Lion> zoo2 = new ArrayList<Lion>();
        ...
        // num2라는 배열변수에는 String 타입값만 저장할 수 있음
