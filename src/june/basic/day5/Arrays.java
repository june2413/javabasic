...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		// 배열생성시 몇개의 요소를 저장할지 갯수를 미리지정해야 함
		...
		// 1~45사이 임의의 숫자 6개를 출력하는 프로그램 작성
		// 임의의 숫자를 생성 : 난수 random
		// Randon 클래스를 이용하면 원하는 형태의 난수 생성가능
