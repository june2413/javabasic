...
public class Polymoph {
    public static void main(String[] args) {
        ...
        // 즉, 변수에 값이 저장될때나,함수 호출시 실제 함수가 위치한
        // 메모리상의 주소와 연결하는 것을 의미
