...
public class JavaString {
    public static void main(String[] args) {
        ...
        // chatAt, concat, indexOf, trim, toLowerCase,
        // toUpperCase, length, split, substring


        // 자바에서 String 객체는 메모리 재활용(interning)함
        // 즉, 생성된 String 객체값을 String Pool에 저장하는데,
        // 그 다음에 생성하는 String 객체값이 이전과 유사한 경우
        ...
        if(str1 == str2) System.out.println("str1과 str2의 저장위치가 같음");
        if(str1 == str3) System.out.println("str1과 str3의 저장위치가 같음");
        ...
        // 문자열에 + 연산자를 사용하면 StringBuilder로 변환한 후 먼저
        ...
        // substring : 문자열의 시작위치부터 끝위치 -1까지의 문자열을
        //              추출하는 메서드
        // substring(시작)
        // substring(시작, 끝 -1)
