...
class NonOver{
    ...
    // 다형성이 적용되지 않으면
    // 생성한 메서드 마다 이름을 제각각 정해야 하므로
    // 개발자가 일일이 기억해서 사용해야 하는 번거로움 초래래
}
...
// 개발자가 메서드를 일일이 외울 필요 없음
// 단지, 메서드를 어떻게 호출할지 알고 있으면됨